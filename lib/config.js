...
module.exports.settings = function () {
  ...
  if (config_file !== "") {
    if (config_file.length > 0) {
      console.log("linter-urho3dlinter: Reading settings from: " + config_file);
    } else {
      console.log("linter-urho3dlinter: Using configuration page settings");
    }
  }
  ...
  if (config_file !== "") {
      ...
      return {
          enabled: atom.config.get("linter-urho3dlinter.enabled"),
